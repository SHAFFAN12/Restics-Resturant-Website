  ...
  return (
    <div className="bg-red-600 mb-4 py-4 relative">
      ...
      <div className="relative mt-6 ">
        ...
        {/* ✅ Centered Buttons */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-xl shadow-lg flex flex-wrap justify-center gap-3">
